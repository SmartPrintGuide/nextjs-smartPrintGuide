            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
                ...
                {cartItems.length === 0 ? (
                    <div className="bg-white/90 border border-dashed border-blue-200 rounded-[3rem] p-20 text-center flex flex-col items-center justify-center space-y-6">
                        ...
                        <Link href="/" className="px-8 py-4 bg-blue-700 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-blue-900 transition-all">
                            Browse Inventory
                        </Link>
                    </div>
                ) : (
                                        ...
                                        <div key={item.product} className="p-6 grid grid-cols-1 md:grid-cols-5 gap-6 items-center hover:bg-blue-50/50 transition-colors">
                                            ...
                                            <div className="col-span-1 md:col-span-2 flex gap-6 items-center">
                                                ...
                                                <div className="space-y-1">
                                                    <Link href={`/product/${item.slug}`} className="text-sm font-extrabold text-blue-800 uppercase tracking-tight hover:text-blue-600 transition-colors line-clamp-1">
                                                        {item.title}
                                                    </Link>
