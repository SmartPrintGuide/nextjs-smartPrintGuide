...
const OrderDetails = ({ id: propId }) => {
    const pathname = usePathname();
    const id = propId || (pathname && pathname.split('/')[2]);
    ...
    if (error) return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 gap-6 p-4">
            ...
            <Link href="/profile" className="px-8 py-4 bg-blue-700 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-blue-900 transition-all">Back to Fleet Overview</Link>
        </div>
    );
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 py-12 pb-24">
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="flex items-center justify-between mb-8">
                    <Link href="/profile" className="flex items-center gap-2 text-blue-400 hover:text-blue-900 transition-colors group">
                                ...
                                {order.orderItems.map((item, index) => (
                                    <div key={index} className="py-6 flex flex-col sm:flex-row gap-6 items-center group">
                                        ...
                                        <div className="flex-1 text-center sm:text-left">
                                            <Link href={`/product/${item.product}`} className="text-sm font-black text-blue-800 uppercase tracking-tight hover:text-blue-600 transition-colors">
                                                {item.name}
                                            </Link>
                    ...
                    <div className="space-y-8 h-fit lg:sticky lg:top-24">
                        ...
                        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 md:p-10 shadow-lg border border-blue-100 space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <Link href="/customer-service" className="flex items-center justify-center gap-2 text-blue-600 text-[9px] font-black uppercase tracking-widest hover:gap-3 transition-all">
