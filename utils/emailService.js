...
const sendEmail = async ({ to, subject, html, text, from, replyTo }) => {
    try {
        ...
        const mailOptions = {
            from: from || `"Smart Print Guide" <${process.env.EMAIL_FROM || 'no-reply@smartprintguide.com'}>`,
            to,
            subject,
            html,
            text,
