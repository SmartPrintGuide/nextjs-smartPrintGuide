...
const sendOTPEmail = async (email, otp, type = 'registration') => {
  const subject = type === 'registration'
    ? 'Verify Your Account - Smart Print Guide'
    : 'Reset Your Password - Smart Print Guide';
  ...
  return await sendEmail({
    ...
    subject,
    html,
    from: `"Smart Print Guide" <${process.env.OTP_FROM_EMAIL || 'no-reply@smartprintguide.com'}>`,
  });
};
